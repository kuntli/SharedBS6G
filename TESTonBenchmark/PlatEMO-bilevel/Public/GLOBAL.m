...
%            assert(notermination,'GLOBAL:Termination','Algorithm has terminated');
    ...
    methods(Access = private, Static)
        ...
        function Output(obj)
            clc; fprintf('%s on %s, %d upper level objectives %d lower level objectives, %d upper level variables %d lower level variables, run %d (%6.2f%%), %.2fs passed...\n',...
                         func2str(obj.algorithm),class(obj.problem),obj.u_M,obj.l_M,obj.u_D,obj.l_D,obj.run,obj.u_evaluated/obj.u_evaluation*2500,obj.runtime);
