function [output,Idx_oA,Archive,RPs] = RefineSearch_st(output,Idx_oA,Archive,RPs,tm,Global)
%UNTITLED5 此处显示有关此函数的摘要
        ...
        for i = 1:length(Archive)  
            ...
            idx_p = find(Idx_oA == i); %output中，属于SP{idx(i)}的个体序�? 
            if sum(idx_p>length(output))
               t=0; 
            end
