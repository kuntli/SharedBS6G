classdef SharedBS6G_s2 < PROBLEM
% <problem> <DS>
...
%--------------------------------------------------------------------------
    ...
    methods
        %% Initialization
        function obj = SharedBS6G_s2()
            fullpath = mfilename('fullpath'); 
            [path,~]=fileparts(fullpath);
            try
                load([path,'/Setting_s2.mat']);
            catch
                rb_down_num = 100;
                rb_up_num = 20;
                cs_num = 60;
                ...
                e  = 1800;
                Fcov_min = 0.95;
                save([path,'/Setting_s2.mat'],'rb_down_num','rb_up_num','cs_num','area','CS','CS_COST','Bh_C_u','op_frequency','CS_RENT','op_num','tp_num','TP','rate_up_min','rate_down_min','height_type','total_power_type','phi','BGmax','e','Fcov_min');
            end
