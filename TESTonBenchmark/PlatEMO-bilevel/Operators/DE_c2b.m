function Offspring = DE_c2b(Parent1,Parent2,Parent3,type,Parameter)
...
%--------------------------------------------------------------------------
    ...
    Site = rand(N,D) < CR;
    Offspring       = Parent1;
    Offspring(Site) = Offspring(Site) + F/2*(Offspring(Site)-Parent2(Site)+Offspring(Site)-Parent3(Site));
